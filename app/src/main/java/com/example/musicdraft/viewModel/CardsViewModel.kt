...
class CardsViewModel(application: Application,private val marketplaceViewModel: MarketplaceViewModel, private val loginViewModel: LoginViewModel): AndroidViewModel(application) {
    ...
    private val ownArtistRepo: UserArtistCardRepo = UserArtistCardRepo(dao!!, marketplaceViewModel,this)
